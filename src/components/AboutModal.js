...
export default class ModalMaker extends React.Component {
  ...
  render() {
    return (
      <div>
        <div className="trig" onClick={this.open.bind(this)}>
          About
        </div>
        ...
        <Modal show={this.state.showModal} onHide={this.close}>
          ...
          <Modal.Body>
            ...
            <p>
              {" "}
              Postcards From Anywhere is a web application that allows you to
              make custom postcards using the Google Street View API. To make a
              postcard:
            </p>
