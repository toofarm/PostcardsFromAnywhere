...
export default class CardBuilder extends React.Component {
  constructor(props) {
    ...
    this.writeHeadline = this.writeHeadline.bind(this);
  ...
  downloadCard(e) {
    ...
    domtoimage
      .toJpeg(document.getElementById("card-maker-holder"), { quality: 1 })
    ...
    domtoimage
      .toJpeg(document.getElementById("back-maker-holder"), { quality: 1 })
      .then(function (dataUrl) {
        var link = document.getElementById("downloader-hidden");
      ...
      <div className="ui-holder container-fluid">
        <div className="row canvas-shell">
          <div className="col-lg-6 col-lg-push-1">
            ...
            >
              <canvas id="card-maker"></canvas>
              <Draggable bounds="parent">
                <div className="headline" id="headline-holder"></div>
              </Draggable>
            </div>
            <div className="spacer"></div>
            <div
              id="back-maker-holder"
              className="canvas2"
              style={{
                display: this.state.canvasReveal === true ? "block" : "none",
              }}
            >
              <canvas id="back-maker"></canvas>
